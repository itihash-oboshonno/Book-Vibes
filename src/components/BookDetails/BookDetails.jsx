        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="btn hover:bg-primGreen border border-primGreen hover:text-white bg-transparent text-primGreen text-base shadow-none"
            >
              Mark As Read
            </button>
            <button
              onClick={() => handleAddToWishList(id)}
              className="btn hover:bg-[#50B1C9] hover:text-white border border-[#50B1C9] bg-transparent hover:border-[#50B1C9] text-[#50B1C9] text-base"
            >
              Add To Wishlist
            </button>
          </div>
